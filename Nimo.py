...
os.system(f"ffmpeg -headers $'User-Agent: Mozilla/5.0 (Android; vivo V2311) Android/14 version/1.17.74\r\nHost: livestreamc.prdv3.dlivecdn.com\r\nConnection: Keep-Alive\r\nAccept-Encoding: identity\r\nReferer: https://dlive.tv/\r\n' -re -i '{esponse44}' -threads 4 -vcodec libx264 -b:v 9000k -preset ultrafast -tune zerolatency -flags low_delay -fflags '+nobuffer+flush_packets' -max_delay 0 -muxdelay 0 -x264opts keyint=30 -acodec copy -f flv 'rtmp://txpush.rtmp.nimo.tv/live/su2299515339885rcaf93ac2e0aee5c25cedf5d4c5fadf81?guid=0aa89b1d4ad38c663d01621d631d83b1&hyapp=81&hymuid=2299515339885&hyroom=4490358181&psign=8a8ac319512bd79118f1d1e782433c38&rtag=cah5FXgQJ9&sru=EF9IQO2I1&txHost=txpush.rtmp.nimo.tv&ua=d2ViJjEuMC40Jm5pbW9UVg==&appid=81&room=4490358181&muid=4599030693329&seq=1720967570928&streamcode=huya_inner_user'")
